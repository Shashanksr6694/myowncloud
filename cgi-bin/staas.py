...
if (n=="1") and (a !="") and (b !="") :
	...
	print  "<html>"
	print  "<p><a href='http://192.168.43.98/clienttar/"+user+"_staas.tar' download>Downlode</a>tar file and run it</p>"
	print  "</html>"
...
#ISCSI--------------------------------------------------------------------
	...
	print  "<html>"
	print  "<p><a href='http://192.168.43.98/clienttar/"+user+"_iscsi.tar' download>Downlode</a> tar file and run it.......</p>"
	print  "</html>"
